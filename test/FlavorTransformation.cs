namespace unit_test
{
    ...
    public class FlavorTransformationTest
    {
        ...
        [Theory]
        [InlineData("u", "d", 0.974f)]
        [InlineData("u", "s", 0.225f)]
        [InlineData("u", "b", 0.003f)]
        [InlineData("c", "d", 0.225f)]
        [InlineData("c", "s", 0.973f)]
        [InlineData("c", "b", 0.041f)]
        [InlineData("t", "d", 0.009f)]
        [InlineData("t", "s", 0.040f)]
        [InlineData("t", "b", 0.999f)]
